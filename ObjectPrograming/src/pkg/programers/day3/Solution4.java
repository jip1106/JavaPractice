...
public class Solution4 {
	public int[] solution(int[] lottos, int[] win_nums) {
        ...
        //민우가 구매한 로또 번호를 담은 배열 lottos, 당첨 번호를 담은 배열 win_nums
        //lottos 	=> 구매한 번호
        //win_nums 	=> 당첨 번호
        
        //1.로또 for문만큼 돌면서 0 인 갯수 확인
        //2.구매한 번호중 일치하는 갯수 확인
        //3.등수체크 
        /*
         	맞은 갯수가 한개도 없는 경우...
        ...
        */
        ...
        eqCnt =  ( eqCnt == 0 ) ? 1 : eqCnt;
        
        
        answer[0] = 7-maxCnt;			//최고순위
        answer[1] = 7-eqCnt;		//최저순위
...
0 0 1 25 31 44			 6 10 19 45			맞는 갯수 : 2
